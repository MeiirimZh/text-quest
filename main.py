...
class Game:
    def __init__(self):
        ...
        self.inventory.inventory = self.data.load()["inventory"]

        self.game_state_manager = GameStateManager(self.current_chapter)
        self.chapter1 = Chapter1(self.game_state_manager, self.chapter_1_scene, self.inventory)
        self.chapter2 = Chapter2(self.game_state_manager, self.chapter_2_scene, self.inventory)
